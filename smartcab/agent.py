    ...
    def choose_action(self, state):
        ...
        if self.learning:
            ...
            if draw == random_act:
                ...
                action = self.get_maxQ_Action(self.state)
                print "Action" 
                print action
...
def run():
    ...
    sim = Simulator(env, update_delay = 0.0005, log_metrics = False, optimized = True)
    ...
    sim.run(tolerance = 0.0003, n_test = 10)
